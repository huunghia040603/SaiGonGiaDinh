document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateDropdowns() {
        ...
        populateDropdown(studentMajorSelect, allMajors, 'id', 'name', 'Chọn ngành học');
        populateDropdown(studentAcademicYearSelect, allAcademicYears, 'id', 'year', 'Chọn năm học');
    ...
    form.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            showMessage(`Tạo tài khoản ${isFaculty ? 'giảng viên' : 'sinh viên'} thành công!`, 'sggd-success');
            form.reset();
            resetPhotoPreview();
